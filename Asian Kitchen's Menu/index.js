const menu = [{
  ...
  function addButton() {
	...
	document.getElementById("Japan").addEventListener("click",getJapaneseFoods)
	document.getElementById("China").addEventListener("click",getChineseFoods)
  }
  ...
  function getChineseFoods() {
	section.innerHTML = ""
	const chinaMenu = menu.filter(element => element.category == "China")
  ...
  function getJapaneseFoods() {
	section.innerHTML = ""
	const japanMenu = menu.filter(element => element.category == "Japan")
  ...
  function getKoreanFoods() {
	section.innerHTML = ""
	const koreaMenu = menu.filter(element => element.category == "Korea")
